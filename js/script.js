...
function loadHeaderFooter(callback) {
  ...
  </nav>`; // Keep your current header HTML here
...
Mujmahuda, Vadodara,Gujarat
                ...
                <li>
                  <a class="emailAnchor" href="mailto:contact@kads.co.in">
                    <i class="fa-solid fa-envelope" aria-hidden="true"></i>contact@kads.co.in</a>
                </li>
              </ul>
    ...
    <div class="fab-container">
      <a class="set-url-target" rel="noopener" data-mobile-target="" data-desktop-target="_blank" target="_blank" href="https://api.whatsapp.com/send?phone=917016964352">
    ...
    <div class="Call-fab-container">
      <a rel="noopener" target="_blank" href="tel:+917016964352">
...
(function () {
  const mobileLink = "https://api.whatsapp.com/send?phone=917016964352";
  const desktopLink = "https://web.whatsapp.com/send?phone=917016964352";
